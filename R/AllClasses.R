...
#' @slot id2name Mapping list: KEGG ID to KEGG name (can contain multiple hits)
#' @slot pvalues.size Numeric matrix for the evaluation of CC through their size
...
#'
#' @slot metabolites Character vector containing the affected compounds
#' @slot metabolitesbackground Character vector containing the compounds 
#' for the personalised background. Optionally, can be \code{NULL} for default 
#' background
#' @slot excluded Character vector containing the compounds that have been 
...
#' @slot pathhits Numeric named vector with the quantities "sample_success" 
#' for the hypergeometric distribution (#affected in path)
#' @slot pathbackground Numeric named vector with the quantities "total_success" 
...
#' @slot valid Logical value; is the analysis valid?
#' @slot pvalues Named numeric vector with p-values
#' @slot approx Character; which approximation was used? Can be "simulation" 
#' for Monte Carlo; "normality", "gamma" or "t" for parametric approaches
