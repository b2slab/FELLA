...
checkArguments <- function(
  ...
  if (!is.character(method)) {
    message("'method' must be a character: ", 
  ...
  if (length(method) > 1) {
    message("'method' must be a length 1 character. ", 
            "Returning original 'object'...")
    return(list(ans = object, valid = FALSE))
  }
  ...
  if (length(approx) > 1) {
    message("'approx' must be a length 1 character. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.null(loadMatrix) & length(loadMatrix) > 1)  {
    message("'loadMatrix' can only be a length 1 character ", 
  ...
  if (!is.numeric(threshold)) {
    message("'threshold' must be numeric between 0 and 1. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(threshold) > 1) {
    message("'threshold' must be a length 1 numeric. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.numeric(plimit)) {
    message("'plimit' must be numeric between 1 and 50. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(plimit) > 1) {
    message("'plimit' must be a length 1 numeric. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.numeric(nlimit)) {
    message("'nlimit' must be numeric between 1 and 1000. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(nlimit) > 1) {
    message("'nlimit' must be a length 1 numeric. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  ##############################################################################
  if (!is.numeric(niter)) {
    message("'niter' must be numeric between 1e2 and 1e5. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(niter) > 1) {
    message("'niter' must be a length 1 numeric. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.logical(layout)) {
    message("'layout' must be logical. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }

  if (length(layout) > 1) {
    message("'layout' must be a length 1 logical. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.logical(splitByConnectedComponent)) {
    message("'splitByConnectedComponent' must be logical. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(splitByConnectedComponent) > 1) {
    message("'splitByConnectedComponent' must be a length 1 logical. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.logical(askPlots)) {
    message("'askPlots' must be logical. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(askPlots) > 1) {
    message("'askPlots' must be a length 1 logical. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }  
  ...
  if (!is.numeric(thresholdConnectedComponent)) {
    message("'thresholdConnectedComponent' must be ", 
  ...
  if (length(thresholdConnectedComponent) > 1) {
    message("'thresholdConnectedComponent' must be a length 1 numeric. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (thresholdConnectedComponent <= 0 | 
    ...
    message("'thresholdConnectedComponent' must be numeric between 0 and 1.", 
            " Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.null(GO.CellularComponent) & 
    ...
    message("'GO.CellularComponent' must be NULL or a GO entry. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(GO.CellularComponent) > 1) {
    message("'GO.CellularComponent' must be a length 1 character. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.logical(GONamesAsLabels)) {
    message("'GONamesAsLabels' must be logical. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(GONamesAsLabels) > 1) {
    message("'GONamesAsLabels' must be a length 1 logical. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  ...
  if (!is.numeric(LabelLengthAtPlot)) {
    message("'LabelLengthAtPlot' must be numeric between 10 and 50. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (length(LabelLengthAtPlot) > 1) {
    message("'LabelLengthAtPlot' must be a length 1 numeric. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
  
  if (LabelLengthAtPlot < 10 | LabelLengthAtPlot > 100) {
    message("'LabelLengthAtPlot' must be numeric between 10 and 100. ", 
            "Returning NULL...")
    return(list(ans = NULL, valid = FALSE))
  }
