...
\begin{figure}[!h]
\centerline{\includegraphics[scale=1]{shiny1.png}}
...
\begin{figure}[!h]
\centerline{\includegraphics[scale=1]{shiny2.png}}
...
\begin{figure}[!h]
\centerline{\includegraphics[scale=1]{shiny3.png}}
...
\begin{figure}[!h]
\centerline{\includegraphics[scale=1]{shiny4.png}}
